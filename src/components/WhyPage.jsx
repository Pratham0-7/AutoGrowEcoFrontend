            ...
            <div className="bg-white p-8">
              <div className="mb-6 flex items-center gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#0F5E6E]/10">
                  <svg className="h-4 w-4 text-[#0F5E6E]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <ul className="space-y-4">
                {ageWay.map((item, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="text-sm leading-relaxed text-[#1A2E35]">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
