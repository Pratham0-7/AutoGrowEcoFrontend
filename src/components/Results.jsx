...
const colorMap = {
  violet: { icon: "bg-violet-500/15 text-violet-400 border-violet-500/20", stat: "text-violet-400" },
  blue:   { icon: "bg-blue-500/15 text-blue-400 border-blue-500/20",       stat: "text-blue-400" },
  emerald:{ icon: "bg-emerald-500/15 text-emerald-400 border-emerald-500/20", stat: "text-emerald-400" },
};
...
const ResultCard = ({ result, delay }) => {
  ...
  return (
    <div
      ...
      className="rounded-2xl border border-white/5 bg-white/3 p-7"
    >
      ...
      <p className="mt-2 text-sm leading-relaxed text-slate-400">{result.description}</p>
    </div>
  );
};
  ...
  return (
    <section className="relative bg-slate-950 py-24 sm:py-32">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute left-1/4 top-1/2 h-80 w-80 -translate-y-1/2 rounded-full bg-violet-600/10 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div
          ...
          className="mt-16 overflow-hidden rounded-3xl border border-violet-500/20 bg-linear-to-r from-violet-600/20 via-violet-500/10 to-indigo-600/20"
        >
          <div className="flex flex-col items-center gap-6 px-8 py-10 text-center sm:flex-row sm:justify-between sm:text-left">
            ...
            <div className="flex shrink-0 flex-col gap-3 sm:flex-row">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-violet-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-900/40 transition hover:bg-violet-500"
              >
                Get Started Free
